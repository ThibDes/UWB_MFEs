// ======================================================================
// write_fonction_spi.v generated from TopDesign.cysch
// 02/24/2021 at 15:47
...
module top ;
	...
	wire [0:0] tmpOE__m_miso_pin_net;
	wire [0:0] tmpIO_0__m_miso_pin_net;
	wire [0:0] tmpINTERRUPT_0__m_miso_pin_net;
	electrical [0:0] tmpSIOVREF__m_miso_pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .input_buffer_sel(2'b00))
		m_miso_pin
		 (.oe(tmpOE__m_miso_pin_net),
		  .y({1'b0}),
		  .fb({Net_20}),
		  .io({tmpIO_0__m_miso_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__m_miso_pin_net),
		  .interrupt({tmpINTERRUPT_0__m_miso_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__m_miso_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__m_mosi_pin_net;
	wire [0:0] tmpFB_0__m_mosi_pin_net;
	wire [0:0] tmpIO_0__m_mosi_pin_net;
	wire [0:0] tmpINTERRUPT_0__m_mosi_pin_net;
	electrical [0:0] tmpSIOVREF__m_mosi_pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .input_buffer_sel(2'b00))
		m_mosi_pin
		 (.oe(tmpOE__m_mosi_pin_net),
		  .y({Net_30}),
		  .fb({tmpFB_0__m_mosi_pin_net[0:0]}),
		  .io({tmpIO_0__m_mosi_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__m_mosi_pin_net),
		  .interrupt({tmpINTERRUPT_0__m_mosi_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__m_mosi_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__m_sclk_pin_net;
	wire [0:0] tmpFB_0__m_sclk_pin_net;
	wire [0:0] tmpIO_0__m_sclk_pin_net;
	wire [0:0] tmpINTERRUPT_0__m_sclk_pin_net;
	electrical [0:0] tmpSIOVREF__m_sclk_pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("640f8e70-5666-4015-9ac8-6ed7f71d8e01"),
		  ...
		  .input_buffer_sel(2'b00))
		m_sclk_pin
		 (.oe(tmpOE__m_sclk_pin_net),
		  .y({Net_31}),
		  .fb({tmpFB_0__m_sclk_pin_net[0:0]}),
		  .io({tmpIO_0__m_sclk_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__m_sclk_pin_net),
		  .interrupt({tmpINTERRUPT_0__m_sclk_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__m_sclk_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__m_ss_pin_net;
	wire [0:0] tmpFB_0__m_ss_pin_net;
	wire [0:0] tmpIO_0__m_ss_pin_net;
	wire [0:0] tmpINTERRUPT_0__m_ss_pin_net;
	electrical [0:0] tmpSIOVREF__m_ss_pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("5ec2583b-d6a1-4a86-ac3e-b170e6f000fd"),
		  ...
		  .input_buffer_sel(2'b00))
		m_ss_pin
		 (.oe(tmpOE__m_ss_pin_net),
		  .y({Net_107}),
		  .fb({tmpFB_0__m_ss_pin_net[0:0]}),
		  .io({tmpIO_0__m_ss_pin_net[0:0]}),
		  .siovref(tmpSIOVREF__m_ss_pin_net),
		  .interrupt({tmpINTERRUPT_0__m_ss_pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__m_ss_pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("48009a4a-bc3d-49d1-8ade-aa9336ebe2ef"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4edf9d9a-1f00-460c-90e8-f1de4bde1074"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("00422d37-f867-4fe9-8572-7a5d93e3dd69"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LED_4_net;
	wire [0:0] tmpFB_0__LED_4_net;
	wire [0:0] tmpIO_0__LED_4_net;
	wire [0:0] tmpINTERRUPT_0__LED_4_net;
	electrical [0:0] tmpSIOVREF__LED_4_net;

	cy_psoc3_pins_v1_10
		#(.id("62313a1d-7cbe-4dfb-af39-a3f9554333bd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		LED_4
		 (.oe(tmpOE__LED_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_4_net[0:0]}),
		  .io({tmpIO_0__LED_4_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_4_net),
		  .interrupt({tmpINTERRUPT_0__LED_4_net[0:0]}),
		  .annotation({Net_46}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__rst_in_net;
	wire [0:0] tmpIO_0__rst_in_net;
	wire [0:0] tmpINTERRUPT_0__rst_in_net;
	electrical [0:0] tmpSIOVREF__rst_in_net;

	cy_psoc3_pins_v1_10
		#(.id("e17fe3f5-f0e3-4231-a942-2a7cbd52fe12"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		rst_in
		 (.oe(tmpOE__rst_in_net),
		  .y({1'b0}),
		  .fb({Net_12}),
		  .io({tmpIO_0__rst_in_net[0:0]}),
		  .siovref(tmpSIOVREF__rst_in_net),
		  .interrupt({tmpINTERRUPT_0__rst_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__rst_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    USBFS_v3_20_2 USBP (
        .sof(Net_71),
        .vbusdet(1'b0));
    defparam USBP.epDMAautoOptimization = 0;

	wire [0:0] tmpOE__GPIOJ11_net;
	wire [0:0] tmpFB_0__GPIOJ11_net;
	wire [0:0] tmpIO_0__GPIOJ11_net;
	wire [0:0] tmpINTERRUPT_0__GPIOJ11_net;
	electrical [0:0] tmpSIOVREF__GPIOJ11_net;

	cy_psoc3_pins_v1_10
		#(.id("1e867bef-9828-4a7b-abd6-332bd7a333bd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GPIOJ11
		 (.oe(tmpOE__GPIOJ11_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GPIOJ11_net[0:0]}),
		  .io({tmpIO_0__GPIOJ11_net[0:0]}),
		  .siovref(tmpSIOVREF__GPIOJ11_net),
		  .interrupt({tmpINTERRUPT_0__GPIOJ11_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GPIOJ11_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GPIOJ12_net;
	wire [0:0] tmpFB_0__GPIOJ12_net;
	wire [0:0] tmpIO_0__GPIOJ12_net;
	wire [0:0] tmpINTERRUPT_0__GPIOJ12_net;
	electrical [0:0] tmpSIOVREF__GPIOJ12_net;

	cy_psoc3_pins_v1_10
		#(.id("44e11de8-42fd-4feb-ba05-f3675120119e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GPIOJ12
		 (.oe(tmpOE__GPIOJ12_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GPIOJ12_net[0:0]}),
		  .io({tmpIO_0__GPIOJ12_net[0:0]}),
		  .siovref(tmpSIOVREF__GPIOJ12_net),
		  .interrupt({tmpINTERRUPT_0__GPIOJ12_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GPIOJ12_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GPIOJ13_net;
	wire [0:0] tmpFB_0__GPIOJ13_net;
	wire [0:0] tmpIO_0__GPIOJ13_net;
	wire [0:0] tmpINTERRUPT_0__GPIOJ13_net;
	electrical [0:0] tmpSIOVREF__GPIOJ13_net;

	cy_psoc3_pins_v1_10
		#(.id("e6f09845-e122-49f7-88af-5d8caaaff38d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GPIOJ13
		 (.oe(tmpOE__GPIOJ13_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GPIOJ13_net[0:0]}),
		  .io({tmpIO_0__GPIOJ13_net[0:0]}),
		  .siovref(tmpSIOVREF__GPIOJ13_net),
		  .interrupt({tmpINTERRUPT_0__GPIOJ13_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GPIOJ13_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GPIOJ14_net;
	wire [0:0] tmpFB_0__GPIOJ14_net;
	wire [0:0] tmpIO_0__GPIOJ14_net;
	wire [0:0] tmpINTERRUPT_0__GPIOJ14_net;
	electrical [0:0] tmpSIOVREF__GPIOJ14_net;

	cy_psoc3_pins_v1_10
		#(.id("ede732ff-f1ec-4a0c-804f-69b52e9da4a7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GPIOJ14
		 (.oe(tmpOE__GPIOJ14_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GPIOJ14_net[0:0]}),
		  .io({tmpIO_0__GPIOJ14_net[0:0]}),
		  .siovref(tmpSIOVREF__GPIOJ14_net),
		  .interrupt({tmpINTERRUPT_0__GPIOJ14_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GPIOJ14_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__GPIOJ15_net;
	wire [0:0] tmpFB_0__GPIOJ15_net;
	wire [0:0] tmpIO_0__GPIOJ15_net;
	wire [0:0] tmpINTERRUPT_0__GPIOJ15_net;
	electrical [0:0] tmpSIOVREF__GPIOJ15_net;

	cy_psoc3_pins_v1_10
		#(.id("e7eab09e-6b03-4979-b522-ad6113e7835d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GPIOJ15
		 (.oe(tmpOE__GPIOJ15_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GPIOJ15_net[0:0]}),
		  .io({tmpIO_0__GPIOJ15_net[0:0]}),
		  .siovref(tmpSIOVREF__GPIOJ15_net),
		  .interrupt({tmpINTERRUPT_0__GPIOJ15_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GPIOJ15_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
