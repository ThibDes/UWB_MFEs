...
* Device Descriptors
*********************************************************************/
const uint8 CYCODE USBP_DEVICE0_DESCR[18u] = {
...
* Config Descriptor  
*********************************************************************/
const uint8 CYCODE USBP_DEVICE0_CONFIGURATION0_DESCR[32u] = {
...
*********************************************************************/
const uint8 CYCODE USBP_STRING_DESCRIPTORS[59u] = {
/*********************************************************************
...
/* DescriptorType: STRING                  */ 0x03u,
 ...
 (uint8)'r', 0u,
/*********************************************************************
* String Descriptor: "USBP"
*********************************************************************/
/* Descriptor Length                       */ 0x0Au,
/* DescriptorType: STRING                  */ 0x03u,
 (uint8)'U', 0u,(uint8)'S', 0u,(uint8)'B', 0u,(uint8)'P', 0u,
/*********************************************************************/
...
*********************************************************************/
const T_USBP_EP_SETTINGS_BLOCK CYCODE USBP_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[2u] = {
/* IFC  ALT    EPAddr bmAttr MaxPktSize Class ********************/
{0x00u, 0x00u, 0x81u, 0x02u, 0x0040u,   0x00u},
{0x00u, 0x00u, 0x02u, 0x02u, 0x0008u,   0x00u}
};
const uint8 CYCODE USBP_DEVICE0_CONFIGURATION0_INTERFACE_CLASS[1u] = {
0x00u
};
/*********************************************************************
...
*********************************************************************/
const T_USBP_LUT CYCODE USBP_DEVICE0_CONFIGURATION0_TABLE[4u] = {
    {0x01u,     &USBP_DEVICE0_CONFIGURATION0_DESCR},
    {0x02u,     &USBP_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE},
    {0x00u,    NULL},
    {0x00u,     &USBP_DEVICE0_CONFIGURATION0_INTERFACE_CLASS}
};
/*********************************************************************
* Device Dispatch Table -- Points to the Device Descriptor and each of
*                          and Configuration Tables for this Device 
*********************************************************************/
const T_USBP_LUT CYCODE USBP_DEVICE0_TABLE[3u] = {
    {0x01u,     &USBP_DEVICE0_DESCR},
    {0x00u,    NULL},
    {0x01u,     &USBP_DEVICE0_CONFIGURATION0_TABLE}
};
/*********************************************************************
* Device Table -- Indexed by the device number.
*********************************************************************/
const T_USBP_LUT CYCODE USBP_TABLE[1u] = {
    {0x01u,     &USBP_DEVICE0_TABLE}
};
    ...
    *  USBP_GET_EXTENDED_CONFIG_DESCRIPTOR becomes the bRequest value
    *  in a host vendor device/class request
    ******************************************************************************/

    const uint8 CYCODE USBP_MSOS_DESCRIPTOR[USBP_MSOS_DESCRIPTOR_LENGTH] = {
    /* Descriptor Length                       */   0x12u,
    /* DescriptorType: STRING                  */   0x03u,
    /* qwSignature - "MSFT100"                 */   (uint8)'M', 0u, (uint8)'S', 0u, (uint8)'F', 0u, (uint8)'T', 0u,
                                                    (uint8)'1', 0u, (uint8)'0', 0u, (uint8)'0', 0u,
    /* bMS_VendorCode:                         */   USBP_GET_EXTENDED_CONFIG_DESCRIPTOR,
    /* bPad                                    */   0x00u
    };

    /* Extended Configuration Descriptor */

    const uint8 CYCODE USBP_MSOS_CONFIGURATION_DESCR[USBP_MSOS_CONF_DESCR_LENGTH] = {
...
/* DIE ID string descriptor for 8 bytes ID */
    ...
    uint8 USBP_idSerialNumberStringDescriptor[USBP_IDSN_DESCR_LENGTH];
