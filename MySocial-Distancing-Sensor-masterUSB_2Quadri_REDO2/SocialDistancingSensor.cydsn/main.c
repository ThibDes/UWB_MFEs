    ...
    for (;;){
        switch(state){
            ...
            case STATE_SEND_RESULTS:
                ...
                //DWM_WriteSPI_ext(SYS_CFG, 16, SYS_CFG_PHR_MODE_11, SYS_CFG_LEN); 
                DWM_SendData(TxData, (NUMBER_OF_ANCHOR-1)*DATA_LEN, 1);      //MODIFY DATA LEN !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
                
                //DWM_WriteSPI_ext(SYS_CFG, 16, SYS_CFG_PHR_MODE_00, SYS_CFG_LEN); 
            ...
            case STATE_SEND_RESULTS_PENDING:
                ...
                if (TxOk){
                    TxOk = 0;
                    state = STATE_PREPARE_TO_LISTEN;  // conditoin to add !!!!!!!!!!!!!!!!!!!!!!!!!!!!
